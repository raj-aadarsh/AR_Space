...
function SpiralGalaxy({ assembleProgress }) {
  ...
  return (
    <group ref={groupRef} rotation={[0.42, 0, 0]} position={[-2.2, -0.8, 0]}>
...
function Scene({ assembleProgress }) {
  return (
    <>
      ...
      <SpiralGalaxy assembleProgress={assembleProgress} />
    </>
  )
}
...
export default function Skills() {
  ...
  return (
    ...
    >
      ...
      {/* Right-side gradient — keeps skill tags readable */}
      <div style={{
